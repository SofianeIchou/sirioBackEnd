...
public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String, String> map) {
		...
		msg.append(
				"<p>For any assistance, please feel free to call us at +33 0651960718 or whatsapp helpline numbers.</p>");
		msg.append("<p>You may also write to us at sofiane.ichou.jrbl@gmail.com.</p>");
		msg.append(
